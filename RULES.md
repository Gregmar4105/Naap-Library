...
This document contains global instructions and rules that Antigravity must abide by across all tasks in this workspace. You can edit this file to add project-specific rules, formatting preferences, and other guidelines.
