...
import type { PanelKey } from '@/contexts/panel-context';
...
export default function AppSidebarLayout({
    ...
    const findContainer = (id: string) => {
        if (id in panelColumns) {
return id as 'col1' | 'col2';
}
        ...
        <AppShell variant="sidebar">
            ...
            >
                <div className="flex h-svh w-full items-stretch overflow-hidden p-2 pr-0 gap-2">
                    ...
                    <div className="flex flex-1 min-w-0 flex-col overflow-hidden rounded-xl border bg-card shadow-sm print:border-none print:shadow-none print:rounded-none">
                        <AppContent variant="sidebar" className="flex h-full flex-col overflow-hidden print:overflow-visible">
                            {!hideHeader && (
                                <div className="no-print">
                                    <AppSidebarHeader breadcrumbs={breadcrumbs} />
                                </div>
                            )}
                            <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar print:overflow-visible">
                                {children}
                            </div>
                        </AppContent>
                    </div>
                    ...
                    {!isMobile && (
                        <div className="no-print flex flex-initial gap-2 overflow-hidden h-full">
                ...
                <div className="no-print relative flex h-svh w-13 shrink-0 flex-col items-center gap-4 overflow-hidden bg-[#024495] pt-4 pb-4">
                    <div
