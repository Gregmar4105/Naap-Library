            ...
            <Popover>
                <PopoverTrigger asChild>
                    <Button
                        ...
                        variant={"outline"}
                        className={cn(
                            "w-full sm:w-[280px] justify-start text-left font-normal border-border/50 shadow-sm",
                ...
                <PopoverContent className="w-auto p-0 border-border/50 shadow-xl" align="start">
                    <div className="flex flex-col sm:flex-row">
                        ...
                        <div className="border-b sm:border-b-0 sm:border-r border-border/50">
                            <div className="p-3 border-b border-border/50 flex items-center justify-center gap-2 bg-muted/30">
                                <Select
